...
{
    [Fact]
    public void TrixException_WithMessage_SetsMessage()
    {
        // Arrange & Act
        var ex = new TrixException("Test error");
    ...
    [Fact]
    public void TrixException_WithStatusCode_SetsProperties()
    {
        // Arrange & Act
        var ex = new TrixException("Test error", HttpStatusCode.BadRequest, "ERR001", "req-123");
    ...
    [Fact]
    public void TrixTimeoutException_HasCorrectProperties()
    {
        // Arrange
        var timeout = TimeSpan.FromSeconds(30);

        // Act
        var ex = new TrixTimeoutException("Request timed out", timeout);
